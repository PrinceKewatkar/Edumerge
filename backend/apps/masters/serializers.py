...
class DepartmentSerializer(serializers.ModelSerializer):
    ...
    institution = serializers.IntegerField(source='campus.institution.id', read_only=True)
    institution_name = serializers.CharField(source='campus.institution.name', read_only=True)

    class Meta:
        model = Department
        fields = ['id', 'campus', 'campus_name', 'institution', 'institution_name', 'name', 'code']


class ProgramSerializer(serializers.ModelSerializer):
    department_name = serializers.CharField(source='department.name', read_only=True)
    campus_name = serializers.CharField(source='department.campus.name', read_only=True)
    institution = serializers.IntegerField(source='department.campus.institution.id', read_only=True)
    ...
    class Meta:
        model = Program
        fields = [
            'id', 'department', 'department_name', 'campus_name', 'institution', 'institution_name',
